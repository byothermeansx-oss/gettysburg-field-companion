...
Open the live app, then **Add to Home Screen** (iPhone: Share → Add to Home Screen; Android: ⋮ → Install app).

Base map: U.S. War Dept. (Cope) contour survey, Library of Congress. Photographs: public domain (LOC / Wikimedia).
